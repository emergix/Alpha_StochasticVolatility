...
b=x;
a=Sqrt[-\[Kappa]];
  (*(call=N[Max[f-K,0]+(f-K)/(2Sqrt[2\[Pi]]) E^\[Theta]/x \!\(
...
(* Q[x_,w_]:=1/Sqrt[2\[Pi] w] E^(-(x^2/(2t))+\!\(
...
If[printflag>0,Print["SABROptionAnalytic: \!\(\*FractionBox[
RowBox[{SuperscriptBox[\"\[Alpha]\", \"2\"], \" \", 
RowBox[{\"(\", 
RowBox[{
RowBox[{\"-\", \"2\"}], \"+\", \"\[Beta]\"}], \")\"}], \" \", \"\[Beta]\", \" \", SuperscriptBox[\"K\", 
RowBox[{\"2\", \" \", \"\[Beta]\"}]]}], SuperscriptBox[\"K\", \"2\"]]\)=",SetPrecision[(\[Alpha]^2 (-2+\[Beta]) \[Beta] K^(2 \[Beta]))/K^2,12]," \!\(\*FractionBox[
RowBox[{\"6\", \" \", \"\[Alpha]\", \" \", \"\[Beta]\", \" \", SuperscriptBox[\"K\", \"\[Beta]\"], \" \", \"\[Nu]\", \" \", \"\[Rho]\"}], \"K\"]\)=",SetPrecision[(6 \[Alpha] \[Beta] K^\[Beta] \[Nu] \[Rho])/K,12]," \!\(\*SuperscriptBox[\"\[Nu]\", \"2\"]\) (2-3 \!\(\*SuperscriptBox[\"\[Rho]\", \"2\"]\))=",SetPrecision[\[Nu]^2 (2-3 \[Rho]^2),12]]];
If[printflag>0,Print["SABROptionAnalytic: \!\(\*FractionBox[\"1\", \"2\"]\)Re[(\!\(\*FractionBox[\"1\", 
RowBox[{\"2\", \" \", \"a\"}]]\)(\!\(\*SuperscriptBox[\"\[ExponentialE]\", 
RowBox[{
RowBox[{\"-\", SqrtBox[\"2\"]}], \" \", \"a\", \" \", \"b\"}]]\) \!\(\*SqrtBox[\"\[Pi]\"]\) (1-\!\(\*SuperscriptBox[\"\[ExponentialE]\", 
RowBox[{\"2\", \" \", SqrtBox[\"2\"], \" \", \"a\", \" \", \"b\"}]]\)+\!\(\*SuperscriptBox[\"\[ExponentialE]\", 
RowBox[{\"2\", \" \", SqrtBox[\"2\"], \" \", \"a\", \" \", \"b\"}]]\) Erf[\!\(\*FractionBox[\"b\", 
RowBox[{SqrtBox[\"2\"], \" \", SqrtBox[\"T\"]}]]\)+a \!\(\*SqrtBox[\"T\"]\)]-Erf[\!\(\*FractionBox[
RowBox[{
RowBox[{SqrtBox[\"2\"], \" \", \"b\"}], \"-\", 
RowBox[{\"2\", \" \", \"a\", \" \", \"T\"}]}], 
RowBox[{\"2\", \" \", SqrtBox[\"T\"]}]]\)])))]]=",SetPrecision[1/2 Re[(1/(2 a) (E^(-Sqrt[2] a b) Sqrt[\[Pi]] (1-E^(2 Sqrt[2] a b)+E^(2 Sqrt[2] a b) Erf[b/(Sqrt[2] Sqrt[T])+a Sqrt[T]]-Erf[(Sqrt[2] b-2 a T)/(2 Sqrt[T])])))],12]]];
...
x=Log[(-\[Rho]+\[Nu] z+Sqrt[1-2 \[Nu] \[Rho] z+\[Nu]^2 z^2])/(1-\[Rho])]/\[Nu];(*  x    est la distance geodesique , on approxime la prob de transition par E^(-x^2/(2T)) (1+..)  *)
...
If[printflag>0,Print[" f1overf0=",SetPrecision[f1overf0,12]," SqB0B\[Alpha]z=",SetPrecision[SqB0B\[Alpha]z,12]," I0=",SetPrecision[I0,12]," \[Kappa]=",SetPrecision[\[Kappa],12]," GIntegralAnalytical[\!\(\*SqrtBox[
RowBox[{\"-\", \"\[Kappa]\"}]]\),\!\(\*FractionBox[
RowBox[{\"Abs\", \"[\", \"x\", \"]\"}], SqrtBox[\"2\"]]\),\!\(\*SqrtBox[\"T\"]\)]=",SetPrecision[GIntegralAnalytical[Sqrt[-\[Kappa]],Abs[x]/Sqrt[2],Sqrt[T]],12],
" GIntegralAnalytical2[-\[Kappa],\!\(\*FractionBox[
RowBox[{\"Abs\", \"[\", \"x\", \"]\"}], SqrtBox[\"2\"]]\),\!\(\*SqrtBox[\"T\"]\)]=",SetPrecision[GIntegralAnalytical2[-\[Kappa],Abs[x]/Sqrt[2],Sqrt[T]],12]," intrinsec=",intrinsec]];
...
If[printflag>0,Print["SABRgeneric5: f1overf0=",SetPrecision[f1overf0,12]," SqB0B\[Alpha]z=",SetPrecision[SqB0B\[Alpha]z,12]," I0=",SetPrecision[I0,12]," \[Kappa]=",SetPrecision[\[Kappa],12]," GIntegralAnalytical[\!\(\*SqrtBox[
RowBox[{\"-\", \"\[Kappa]\"}]]\),\!\(\*FractionBox[
RowBox[{\"Abs\", \"[\", \"x\", \"]\"}], SqrtBox[\"2\"]]\),\!\(\*SqrtBox[\"T\"]\)]=",SetPrecision[GIntegralAnalytical[Sqrt[-\[Kappa]],Abs[x]/Sqrt[2],Sqrt[T]],12],
" GIntegralAnalytical2[-\[Kappa],\!\(\*FractionBox[
RowBox[{\"Abs\", \"[\", \"x\", \"]\"}], SqrtBox[\"2\"]]\),\!\(\*SqrtBox[\"T\"]\)]=",SetPrecision[GIntegralAnalytical2[-\[Kappa],Abs[x]/Sqrt[2],Sqrt[T]],12]," intrinsec=",intrinsec]];
...
x=Log[(-\[Rho]+\[Nu] z+Sqrt[1-2 \[Nu] \[Rho] z+\[Nu]^2 z^2])/(1-\[Rho])]/\[Nu];(*  x    est la distance geodesique , on approxime la prob de transition par E^(-x^2/(2T)) DetVanVleck (1+..)  *)
If[printflag>0,
Plot[(-\[Rho]+\[Nu] z1+Sqrt[1-2 \[Nu] \[Rho] z1+\[Nu]^2 z1^2])/(1-\[Rho]),{z1,-0.2,0.2},AxesLabel->{"z","x"}]];
f1overf0=E^((1/4 \[Alpha] b1 \[Nu] \[Rho]+\[Mu]/2) z^2);
...
If[printflag>0,Print["SABRgeneric5: f1overf0=",f1overf0," SqB0B\[Alpha]z=",SqB0B\[Alpha]z," I0=",I0," \[Kappa]=",\[Kappa]," GIntegralAnalytical3[\!\(\*SqrtBox[
RowBox[{\"-\", \"\[Kappa]\"}]]\),\!\(\*FractionBox[
RowBox[{\"Abs\", \"[\", \"x\", \"]\"}], 
RowBox[{
RowBox[{\"SqrtBox\", \"[\", \"2\", \"]\"}], \" \"}]]\),\!\(\*SqrtBox[\"T\"]\)]=",GIntegralAnalytical3[Sqrt[-\[Kappa]],Abs[x]/Sqrt[2] ,Sqrt[T]]]];
...
(*  x    est la distance geodesique , on approxime la prob de transition par E^(-x^2/(2T)) (1+..)  *)
...
If[printflag>0,Print["SABRgeneric7: f1overf0=",f1overf0," SqB0B\[Alpha]z=",SqB0B\[Alpha]z," I0=",I0," \[Kappa]=",\[Kappa]," GIntegralAnalytical3[\!\(\*SqrtBox[
RowBox[{\"-\", \"\[Kappa]\"}]]\),\!\(\*FractionBox[
RowBox[{\"Abs\", \"[\", \"x\", \"]\"}], 
RowBox[{
RowBox[{\"SqrtBox\", \"[\", \"2\", \"]\"}], \" \"}]]\),\!\(\*SqrtBox[\"T\"]\)]=",GIntegralAnalytical3[Sqrt[-\[Kappa]],Abs[x]/Sqrt[2] ,Sqrt[T]]]];
...
If[printflag>0,Print[" SABRgeneric8: f1overf0=",SetPrecision[f1overf0,12]," I0=",SetPrecision[I0,12]," \[Kappa]=",SetPrecision[\[Kappa],12]," GIntegralAnalytical[\!\(\*SqrtBox[
RowBox[{\"-\", \"\[Kappa]\"}]]\),\!\(\*FractionBox[
RowBox[{\"Abs\", \"[\", \"x\", \"]\"}], SqrtBox[\"2\"]]\),\!\(\*SqrtBox[\"T\"]\)]=",SetPrecision[GIntegralAnalytical[Sqrt[-\[Kappa]],Abs[x]/Sqrt[2],Sqrt[T]],12],
" GIntegralAnalytical2[-\[Kappa],\!\(\*FractionBox[
RowBox[{\"Abs\", \"[\", \"x\", \"]\"}], SqrtBox[\"2\"]]\),\!\(\*SqrtBox[\"T\"]\)]=",SetPrecision[GIntegralAnalytical2[-\[Kappa],Abs[x]/Sqrt[2],Sqrt[T]],12]," intrinsec=",intrinsec]];
If[printflag>0,Print["SABRgeneric8: (-3 \!\(\*SuperscriptBox[\"\[Kappa]b1\", \"2\"]\) +2 \[Kappa]b2) \!\(\*SuperscriptBox[\"\[Alpha]\", \"2\"]\)=",SetPrecision[(-3 \[Kappa]b1^2 +2 \[Kappa]b2) \[Alpha]^2,12]," (2 I0 I2-\!\(\*SuperscriptBox[\"I1\", \"2\"]\)) \!\(\*SuperscriptBox[\"\[Nu]\", \"2\"]\)-\!\(\*FractionBox[
RowBox[{\"3\", \" \", \"z\", \" \", SuperscriptBox[\"\[Nu]\", \"3\"], \" \", 
RowBox[{\"(\", 
RowBox[{
RowBox[{\"z\", \" \", \"\[Nu]\"}], \"-\", 
RowBox[{\"2\", \" \", \"\[Rho]\"}]}], \")\"}], \" \", 
RowBox[{\"(\", 
RowBox[{
RowBox[{\"-\", \"1\"}], \"+\", SuperscriptBox[\"\[Rho]\", \"2\"]}], \")\"}]}], 
RowBox[{\" \", 
RowBox[{\"(\", 
RowBox[{\"1\", \"+\", 
RowBox[{SuperscriptBox[\"z\", \"2\"], \" \", SuperscriptBox[\"\[Nu]\", \"2\"]}], \"-\", 
RowBox[{\"2\", \" \", \"z\", \" \", \"\[Nu]\", \" \", \"\[Rho]\"}]}], \")\"}]}]]\)=",SetPrecision[(2 I0 I2-I1^2) \[Nu]^2-(3 z \[Nu]^3 (z \[Nu]-2 \[Rho]) (-1+\[Rho]^2))/ (1+z^2 \[Nu]^2-2 z \[Nu] \[Rho]),12]," (6 b1 \[Alpha] -16 z \[Mu] )\[Nu] \[Rho]=",SetPrecision[(6 b1 \[Alpha] -16 z \[Mu] )\[Nu] \[Rho],12]]];
intrinsec+\[Alpha]/2 Sqrt[2/\[Pi]]SqB0B\[Alpha]z  f1overf0 Sqrt[I0] GIntegralAnalytical2[-\[Kappa],Abs[x]/Sqrt[2],Sqrt[T]]]
