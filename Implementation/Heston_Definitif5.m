...
(*Print["\[Beta]>0 : \[Alpha]LN=",\[Alpha]LN," \[Beta]eff=",\[Beta]eff," HestonNormalCall[\[Rho],\[Lambda]v,S0^2\[Theta]v,S0 \[Kappa],S0^2V,S0,k,T]=", HestonNormalCall[\[Rho],\[Lambda]v,S0^2 \[Theta]v,S0 \[Kappa],S0^2 V,S0,k,T],"  ShiftedLogHestonNormalCallAux[\[Beta]eff,\[Rho],\[Lambda]v,\[Theta]v,\[Kappa],V,S0,k,T]=", ShiftedLogHestonNormalCallAux[\[Beta]eff,\[Rho],\[Lambda]v,\[Theta]v,\[Kappa],V,S0,k,T]];*);
...
\[Beta]5=1/2;
\[Beta]i=0;
{A1,B1}=RiccatiSolve[\[Kappa]1,(\[Lambda] +  I z \[Kappa]1 \[Rho]1),(-I 2\[Beta]1 z-\[Alpha]11^2 z^2),\[Lambda],\[Theta]1,\[Tau]];
{A2,B2}=RiccatiSolve[\[Kappa]2,(\[Lambda] +  I z \[Kappa]2 \[Rho]2),(-I 2\[Beta]2 z-\[Alpha]12^2 z^2),\[Lambda],\[Theta]2,\[Tau]];
{A3,B3}=RiccatiSolve[\[Kappa]3,(\[Lambda] +  I z \[Kappa]3 \[Rho]3),(-I 2\[Beta]3 z-\[Alpha]13^2 z^2),\[Lambda],\[Theta]3,\[Tau]];
{A4,B4}=RiccatiSolve[\[Kappa]4,(\[Lambda]+  I z \[Kappa]4 \[Rho]4),(-I 2\[Beta]4 z-\[Alpha]14^2 z^2),\[Lambda],\[Theta]4,\[Tau]];
{A5,B5}=RiccatiSolve[\[Kappa]5,(\[Lambda]),(-I 2\[Beta]5 z),\[Lambda],\[Theta]5,\[Tau]];
{Ai,Bi}=RiccatiSolve[\[Kappa]i,(\[Lambda]+  I z \[Kappa]i \[Rho]i),(-I 2\[Beta]i z-z^2),\[Lambda],\[Theta]i,\[Tau]];
...
\[Beta]5=0;
\[Beta]i=-(1/2);
{A1,B1}=RiccatiSolve[\[Kappa]1,(\[Lambda] +  I z \[Kappa]1 \[Rho]1),(-I 2 \[Beta]1 z-\[Alpha]i1^2 z^2),\[Lambda],\[Theta]1,\[Tau]];
{A2,B2}=RiccatiSolve[\[Kappa]2,(\[Lambda] +  I z \[Kappa]2 \[Rho]2),(-I 2\[Beta]2 z-\[Alpha]i2^2 z^2),\[Lambda],\[Theta]2,\[Tau]];
{A3,B3}=RiccatiSolve[\[Kappa]3,(\[Lambda] +  I z \[Kappa]3 \[Rho]3),(-I 2\[Beta]3 z-\[Alpha]i3^2 z^2),\[Lambda],\[Theta]3,\[Tau]];
{A4,B4}=RiccatiSolve[\[Kappa]4,(\[Lambda]+  I z \[Kappa]4 \[Rho]4),(-I 2\[Beta]4 z-\[Alpha]i4^2 z^2),\[Lambda],\[Theta]4,\[Tau]];
{A5,B5}=RiccatiSolve[\[Kappa]5,(\[Lambda]+  I z \[Kappa]5 \[Rho]4),(-I 2\[Beta]5 z-z^2),\[Lambda],\[Theta]5,\[Tau]];
{Ai,Bi}=RiccatiSolve[\[Kappa]i,(\[Lambda]),(-I 2\[Beta]i z),\[Lambda],\[Theta]i,\[Tau]];
E^(A1+A2+A3+A4+A5+Ai+B1 V1+B2 V2 +B3 V3 +B4 V4+B5 V5+Bi Vi )]
...
Print["S1 \!\(\*SuperscriptBox[\"\[ExponentialE]\", 
RowBox[{
RowBox[{\"SuperscriptBox\", \"[\", 
RowBox[{\"equivalent\[Sigma]1\", \",\", \"2\"}], \"]\"}], \"T\"}]]\)-Si \!\(\*SuperscriptBox[\"\[ExponentialE]\", 
RowBox[{\"equivalent\[Rho]\", \" \", \"equivalent\[Sigma]1\", \" \", \"equivalent\[Sigma]i\", \" \", \"T\"}]]\)=",S1 E^(equivalent\[Sigma]1^2 T)-Si E^(equivalent\[Rho] equivalent\[Sigma]1 equivalent\[Sigma]i T)];Print[" -(S1 \!\(\*SuperscriptBox[\"\[ExponentialE]\", 
RowBox[{\"equivalent\[Rho]\", \" \", \"equivalent\[Sigma]1\", \" \", \"equivalent\[Sigma]i\", \" \", \"T\"}]]\)-Si \!\(\*SuperscriptBox[\"\[ExponentialE]\", 
RowBox[{
RowBox[{\"SuperscriptBox\", \"[\", 
RowBox[{\"equivalent\[Sigma]i\", \",\", \"2\"}], \"]\"}], \"T\"}]]\))=",-(S1 E^(equivalent\[Rho] equivalent\[Sigma]1 equivalent\[Sigma]i T)-Si E^(equivalent\[Sigma]i^2 T))];
